            ...
            <Container
                ...
                <Wrapper>
                    ...
                    <Form id="registerForm" onSubmit={handleRegister}>
                        ...
                        <InputContainer>
                            <Input id="username" required placeholder="username" type="text" onKeyUp={() => setError("")}></Input>
                            <Label htmlFor="username">Username</Label>
                        </InputContainer>
                        <InputContainer>
                            <Input id="email" required placeholder="email" type="email" onKeyUp={() => setError("")} ></Input>
