...
const NewProduct = () => {
  ...
  return (
    <Container>
      ...
      <ProductForm>
        <ProductFeatureContainer>
            <FeatureTitle>Image</FeatureTitle>
            <FeatureInput
                type="file"
                id="file"
        ...
        <ProductFeatureContainer>
          <FeatureTitle>Description</FeatureTitle>
          <textarea
            rows="5"
        ...
        <ProductFeatureContainer>
            <FeatureTitle>Stock</FeatureTitle>
            <select name="inStock" onChange={handleChange} style={{padding:"10px"}}>
